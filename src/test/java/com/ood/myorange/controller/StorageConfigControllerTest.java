...
import com.ood.myorange.dto.request.ConfigRequest;
import lombok.With;
...
/*
 * Created by Guancheng Lai on 04/04/2020
 */
...
public class StorageConfigControllerTest {
    ...
    @Test
    void getListOfConfiguration() throws Exception {
        testListOfConfig();
    }
    ...
    void getConfiguration() throws Exception {
        ...
        mockMvc.perform( request ).andExpect( status().isOk() )
                ...
                .andExpect( jsonPath(".result_data.aws_ssecret_access_key", is("accesskey1") ))
                ...
                .andExpect( jsonPath(".result_data.azure_token", is("null") ))
                .andDo( print() );
        ...
        mockMvc.perform( request ).andExpect( status().isOk() )
                ...
                .andExpect( jsonPath(".result_data.aws_access_key_id", is("null") ))
                .andExpect( jsonPath(".result_data.aws_ssecret_access_key", is("null") ))
                .andExpect( jsonPath(".result_data.aws_region", is("null") ))
                .andExpect( jsonPath(".result_data.aws_bucket_name", is("null") ))
    ...
    void addConfiguration() throws Exception {
        ...
        ConfigRequest addConfigRequest = new ConfigRequest();
        addConfigRequest.setName( "myAzure2.0" );
        addConfigRequest.setType( "Azure" );
        addConfigRequest.setAzure_token( "azure_token_2.0" );

        RequestBuilder request = null;
        request = MockMvcRequestBuilders.post("/admin/config/storage/add")
                .contentType( MediaType.APPLICATION_JSON_VALUE )
                .content( objectMapper.writeValueAsString( addConfigRequest ) );
    ...
    @Test
    void editConfig() throws Exception {
        testListOfConfig();

        ConfigRequest editConfigRequest = new ConfigRequest();
        editConfigRequest.setName( "myAzure2.0" );
        editConfigRequest.setType( "Azure" );
        editConfigRequest.setAzure_token( "azure_token_2.0" );

        RequestBuilder request = null;
        request = MockMvcRequestBuilders.put("/admin/config/storage/edit/2")
                .contentType( MediaType.APPLICATION_JSON_VALUE )
                .content( objectMapper.writeValueAsString( editConfigRequest ) );
        mockMvc.perform( request )
                .andExpect( status().isOk() );
    ...
    void deleteConfig() throws Exception {
        ...
        RequestBuilder request = null;
        request = MockMvcRequestBuilders.post("/admin/config/storage/delete/2");
        mockMvc.perform( request )
    ...
    void testListOfConfig() throws Exception {
        ...
        mockMvc.perform( request ).andExpect( status().isOk() )
                ...
                .andExpect( jsonPath(".result_data[0].aws_ssecret_access_key", is("accesskey1") ))
                ...
                .andExpect( jsonPath(".result_data[0].azure_token", is("null") ))
                ...
                .andExpect( jsonPath(".result_data[1].aws_access_key_id", is("null") ))
                .andExpect( jsonPath(".result_data[1].aws_ssecret_access_key", is("null") ))
                .andExpect( jsonPath(".result_data[1].aws_region", is("null") ))
                .andExpect( jsonPath(".result_data[1].aws_bucket_name", is("null") ))
