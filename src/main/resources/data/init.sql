...
CREATE TABLE `departments` (
  `dept_no` char(32) NOT NULL COMMENT 'pk',
  `dept_name` varchar(40) NOT NULL COMMENT 'dept_name',
  PRIMARY KEY (`dept_no`),
...
INSERT INTO `departments` VALUES ('d003','human resource'),('d001','marketing'),('d004','production'),('d005','research and development'),('d002','finance'),('d006','quality'),('d008','sales and service'),('d007','sales');
...
CREATE TABLE `dept_emp` (
  `emp_no` int(11) NOT NULL COMMENT 'pk',
  `dept_no` char(4) NOT NULL COMMENT 'pk',
  `from_date` date NOT NULL COMMENT 'begin time',
  `to_date` date NOT NULL COMMENT 'end time',
...
CREATE TABLE `salaries` (
  ...
  `from_date` date NOT NULL COMMENT 'pk',
